...
import BannerTwo from "@/assets/imgs/banner/banner-two.svg";
import BannerThree from "@/assets/imgs/banner/banner-three.svg";
...
class AppAsset {
  ...
  // Banners
  static BannerOne = BannerOne;
  static BannerTwo = BannerTwo;
  static BannerThree = BannerThree;
  ...
  static UncheckedIcon = UncheckedIcon;

  static ArrowUpIcon = ArrowUpIcon;
