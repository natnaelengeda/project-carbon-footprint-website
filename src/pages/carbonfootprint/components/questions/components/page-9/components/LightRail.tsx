  ...
  return (
    <div
      ...
      <div
        ...
        <p className="text-[25px]"><CarbonLanguage name="public_transportation" /> - <CarbonLanguage name="light_rail" /></p>
      </div>
