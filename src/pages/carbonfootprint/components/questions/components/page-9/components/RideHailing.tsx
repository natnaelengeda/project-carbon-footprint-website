  ...
  return (
    <div
      ...
      <div
        ...
        <p className="text-[25px]"><CarbonLanguage name="public_transportation" /> - <CarbonLanguage name="ride_hailing_service" /></p>
      </div>
