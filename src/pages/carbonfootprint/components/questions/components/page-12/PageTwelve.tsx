    ...
    <QuestionsLayout
      ...
      <div
        ...
        <div
          ...
          <p className="text-[50px]">Vegetables</p>
        </div>

        {/* Options */}
        <div
          className="w-full h-auto flex flex-col items-start justify-start pl-40 pt-20 gap-10">
          <p className="text-[30px] text-white">You use <span className="text-primary">Vegetables for {selectedDays} days</span> per week.</p>
        </div>
      </div>
    </QuestionsLayout>
  )
